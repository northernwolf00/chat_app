...
class _ChatScreenState extends State<ChatScreen> {
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<QuerySnapshot>(
        stream:
            FirebaseFirestore.instance.collection('secretWords').snapshots(),
            ...
            child: InkWell(
              onTap: () {
                if (_textController.text.trim().isNotEmpty) {
                  ...
                  final isSecret = _secretWords
                      .any((word) => text.toLowerCase().contains(word));
                  ...
                  if (isSecret) {
                    showDialog(
                      ...
                      builder: (_) => AlertDialog(
                        ...
                        content: Text('this_word_is_restricted'.tr()),
                        actions: [
                          TextButton(
                              onPressed: () => Navigator.pop(context),
                              child: const Text('OK'))
